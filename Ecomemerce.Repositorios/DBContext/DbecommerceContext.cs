...
namespace Ecomemerce.Repositorios.DBContext;
...
public partial class DbecommerceContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__A3C02A10480AC0D1");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__AAA5CEC239E8D249");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__098892102C413ABA");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__5B65BF97AE738758");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__BC1240BDB841E225");
